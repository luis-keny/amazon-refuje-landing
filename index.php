...
<head>
  ...
  <title>Amazon Refuge</title>
  <meta name="description" content="It is a unique and visionary initiative in the Peruvian Amazon region. This project has been conceived with the goal of offering a safe, sustainable, and prosperous environment for families looking for an escape from global tensions, while also representing an excellent investment opportunity.">
  <link rel="icon" href="./assets/image/logo.webp" type="image/webp">
  <link rel="stylesheet" href="style.css">

  <!-- Open Graph / Facebook -->
  <meta property="og:title" content="Amazon Refuge">
  <meta property="og:description" content="Discover a unique and visionary initiative in the Peruvian Amazon. We offer a safe and sustainable environment for families, as well as an excellent investment opportunity.">
  ...
  <meta name="twitter:title" content="Amazon Refuge">
  <meta name="twitter:description" content="Join our visionary initiative in the Peruvian Amazon. A safe and sustainable environment for families, with great investment opportunities.">
...
<body>
  <header class="header">
    <div class="header__container">
      <img src="./assets/image/logo.webp" alt="logo amazon refuge" class="header__logo">
      <label class="toggle">
        <span>
  ...
  <section class="hero" style="background-image: url('./assets/image/hero.webp')">
    <div class="hero__description">
      <p>FIND PEACE IN UNCERTAIN TIMES</p>
      <p>LIVE IN THE AMAZON</p>
    </div>
    <a href="#main" class="hero__btn">
      ...
      <span class="hero__btn--text">Keep browsing</span>
    </a>
  </section>

  <section id="main" class="main">
    <img loading="lazy" class="main__flower" src="./assets/image/flor.webp" alt="flower">
    ...
    <article class="main__description">
      <p class="main__description--text">
        It is a unique and visionary initiative in the Peruvian Amazon region. This project has been conceived with the objective of offering a safe, sustainable, and prosperous environment for families seeking an escape from global tensions, while also representing an excellent investment opportunity.
      </p>
      <img loading="lazy" class="main__description--img" src="./assets/image/about.webp" alt="refuge image">
    </article>
  </section>
  ...
  <section id="about" class="about">
    ...
    <article class="about__description">
      <div class="about__description--btns">
        <button class="about__description--btn active">Location</button>
        <button class="about__description--btn">Tourism</button>
        <button class="about__description--btn">Sustainability</button>
        <span></span>
      </div>
      <div class="about__description--text">
        <p>It is located in one of the most biodiverse and protected regions on the planet, offering a unique opportunity to live in harmony with nature.</p>
        <p>The project is designed to ensure the comprehensive safety of families by providing access to an inexhaustible source of water and natural resources, ensuring long-term self-sufficiency.</p>
      </div>
      <div class="about__description--text hidden">
        <p>It offers opportunities to generate sustainable income through ecotourism and the rental of country houses, allowing owners not only to enjoy a privileged environment but also to take advantage of the growth of tourism in the region.</p>
      </div>
      <div class="about__description--text hidden">
        <p>As part of our sustainability vision, Refugio Amazonas Madre de Dios will have 3 Germplasm Banks aimed at ensuring food security and promoting the preservation of native species, contributing to global biodiversity and the development of sustainable agricultural practices.</p>
      </div>
    </article>
  </section>

  <section id="location" class="location">
    <img loading="lazy" class="location__leaf" src="./assets/image/hoja.webp" alt="leaf">
    <div class="title">
      <div>
    ...
    <div class="location__container">
      <article class="location__description">
        ...
        <p>Located in the city of Puerto Maldonado, Tambopata Province and District, Madre de Dios Department, we have an area of 61 hectares and/or 150.734 acres. We have 406 meters of river frontage with the Madre de Dios River, the largest navigable river in the region.</p>
      </article>
      <div class="location__coordinates">
        <article class="location__coordinates--utm">
          <h4 class="location__coordinates--utm--title">UTM COORDINATES</h4>
          <ul class="location__coordinates--utm--list">
            <li>
              <h4>Point 1</h4>
              <p><strong>East: </strong><span>500884.00</span></p>
              <p><strong>North: </strong><span>8617761.00</span></p>
            </li>
            <li>
              <h4>Point 2</h4>
              <p><strong>East: </strong><span>501280.00</span></p>
              <p><strong>North: </strong><span>8617742.00</span></p>
            </li>
            <li>
              <h4>Point 3</h4>
              <p><strong>East: </strong><span>501465.00</span></p>
              <p><strong>North: </strong><span>8618630.00</span></p>
            </li>
            <li>
              <h4>Point 4</h4>
              <p><strong>East: </strong><span>500988.00</span></p>
              <p><strong>North: </strong><span>8618709.00</span></p>
            </li>
            <li>
              <h4>Point 5</h4>
              <p><strong>East: </strong><span>500556.00</span></p>
              <p><strong>North: </strong><span>8618684.00</span></p>
            </li>
          </ul>
        </article>
        <img loading="lazy" class="location__coordinates--img" src="./assets/image/coordenadas.webp" alt="coordinates">
      </div>
    </div>
  </section>
  ...
  <section id="differential" class="differential">
    ...
    <img loading="lazy" class="differential__leaf" src="./assets/image/hoja.webp" alt="leaf">
    <div class="title">
      <div>
        <svg width="61" height="50" viewBox="0 0 61 50" fill="none">
          <path d="M60.4973 47.4387C60.4963 47.3942 60.4943 47.3497 60.4905 47.3051C60.488 47.2754 60.4848 47.2461 60.4811 47.2165C60.476 47.1752 60.4699 47.1341 60.4623 47.0929C60.4564 47.0604 60.4496 47.0283 60.4423 46.9966C60.4338 46.9599 60.4246 46.9236 60.4142 46.8871C60.4041 46.8516 60.3931 46.8166 60.3812 46.7818C60.3703 46.7499 60.3589 46.7184 60.3466 46.687C60.3316 46.6489 60.3155 46.6114 60.2984 46.5743C60.2857 46.5466 60.2727 46.519 60.2587 46.4917C60.2388 46.4527 60.2177 46.4147 60.1955 46.3771C60.1864 46.3618 60.1793 46.3458 60.1699 46.3306L39.247 12.5723V7.03778C39.247 5.82266 38.2619 4.83758 37.0467 4.83758C35.8316 4.83758 34.8465 5.82266 34.8465 7.03778V12.5124L31.1868 16.1722L27.7805 10.8404V2.50953C27.7805 1.29441 26.7954 0.309326 25.5803 0.309326C24.3652 0.309326 23.3801 1.29441 23.3801 2.50953V10.8406L0.846055 46.1129C0.590586 46.5128 0.482422 46.9639 0.504336 47.4044C0.503281 47.4331 0.5 47.4613 0.5 47.4903C0.5 48.7054 1.48508 49.6905 2.7002 49.6905H47.7162H48.4603H58.2928C58.2958 49.6905 58.299 49.6908 58.3019 49.6908C58.37 49.6908 58.4381 49.6864 58.5061 49.6802C58.5187 49.679 58.5311 49.6777 58.5435 49.6763C58.6736 49.6619 58.8034 49.6359 58.931 49.5975C58.9487 49.5923 58.9661 49.5865 58.9838 49.5807C59.0299 49.5656 59.0755 49.5488 59.1208 49.5305C59.137 49.5241 59.1534 49.5181 59.1693 49.5112C59.2246 49.4873 59.2794 49.461 59.3333 49.4321C59.3513 49.4224 59.3687 49.4118 59.3864 49.4017C59.4104 49.3879 59.4349 49.3751 59.4587 49.3604C59.4693 49.3538 59.4787 49.3459 59.4891 49.3393C59.5239 49.3168 59.5577 49.2931 59.5911 49.2687C59.6184 49.2489 59.6457 49.2291 59.672 49.2083C59.6989 49.1867 59.7248 49.1638 59.7507 49.1411C59.7802 49.1151 59.8097 49.0893 59.8375 49.0622C59.8583 49.042 59.8776 49.0208 59.8974 48.9998C59.9271 48.9684 59.9565 48.9372 59.9841 48.9044C60.0018 48.8835 60.0181 48.8615 60.035 48.8398C60.0614 48.8059 60.0879 48.7722 60.112 48.7368C60.1296 48.7113 60.1456 48.6844 60.1621 48.6581C60.1825 48.6255 60.2032 48.5933 60.2218 48.5597C60.24 48.527 60.2561 48.4933 60.2727 48.4595C60.2867 48.4308 60.3016 48.4024 60.3143 48.3732C60.3311 48.3349 60.3455 48.2955 60.3602 48.2561C60.37 48.2295 60.3806 48.2031 60.3894 48.1762C60.4024 48.1363 60.4133 48.0956 60.4239 48.0548C60.4316 48.0261 60.4396 47.9976 60.4461 47.9685C60.4543 47.9313 60.4606 47.8934 60.467 47.8554C60.4728 47.8205 60.4787 47.7856 60.4829 47.7504C60.4868 47.7182 60.4891 47.6854 60.4914 47.6526C60.4945 47.6104 60.4972 47.5682 60.4979 47.5259C60.498 47.5138 60.4996 47.5021 60.4996 47.4899C60.5 47.4726 60.4978 47.4558 60.4973 47.4387ZM6.59365 45.2901L25.5803 15.5704L28.966 20.8703C28.9675 20.8725 28.9688 20.8748 28.9704 20.8771L30.864 23.8412L18.0182 45.2901H6.59365ZM23.1472 45.2901L33.5114 27.9851L44.5669 45.2901H23.1472ZM49.7888 45.2901L33.6124 19.9696L36.7252 16.8568L54.3476 45.2901H49.7888Z" fill="#034F29"/>
    ...
    <div class="differential__container">
      <article class="differential__description">
        <div class="differential__description--text">
          <h3>Physical and Food Security for You and Your Family</h3>
          <p>"Refugio Amazónico Madre de Dios" features 1000 m2 plots with self-sufficient and sustainable country houses. These houses will provide energy and food independence.</p>
          <p>We will have a tour operator that will generate residual income from the visits and stays of tourists in our Eco Village.</p>
        </div>
        <img loading="lazy" class="differential__description--img" src="./assets/image/seguridad-fisica-sanitaria.webp" alt="physical and food security">
      </article>
      <article class="differential__description left">
        <div class="differential__description--text">
          <h3>27 HECTARES OF GERMPLASM BANK</h3>
          <p>We have 03 germplasm banks, each 9 hectares, strategically located to safeguard food independence throughout the eco village. In the germplasm bank, we will have medicinal plants, fruit trees, and timber trees.</p>
        </div>
        <img loading="lazy" class="differential__description--img" src="./assets/image/hectarias.webp" alt="germplasm bank">
      </article>
      <article class="differential__description">
        <div class="differential__description--text">
          <h3>ECO VILLAGE</h3>
          <p>The property area is 1000 m2, with a proposed country house of 80 m2.</p>
          <p>Kitchen, dining room, living room, 3 bedrooms, a full bathroom, laundry room, and terrace.</p>
          <p>The property features fruit trees such as coconut, mango, papaya, and others as needed or desired.</p>
          <p>We have medicinal plants like Cat's Claw (for cancer), san (for infections), Sacha Jergon (for cancer treatment or immune system strengthening), and a wide range of herbal remedies.</p>
        </div>
        <img loading="lazy" class="differential__description--img" src="./assets/image/eco-aldea.webp" alt="eco village">
      </article>
    </div>
  </section>
  ...
  <section class="information">
    <article class="information__container">
      <div class="title">
        ...
        <h2>PANDEMICS AND WARS</h2>
      </div>
      <p>"Thanks to our privileged geographical location and access to an inexhaustible source of natural resources, Refugio Amazónico Madre de Dios positions itself as a self-sufficient eco village. Here, families will find comprehensive security, far from the risks of nuclear disasters, and with the peace of mind of living in harmony with nature."</p>
    </article>
  </section>
  ...
  <section id="benefits" class="benefits">
    ...
    <ul class="benefits__list">
      <li>
        ...
        <span>Airport in the city</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>Pure water well</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>No chemical residues</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
      ...
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>Non-GMO foods</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>Organic gardens</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>Near two borders</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>Navigable river</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>Access via the Madre de Dios River.</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>Source of water resources</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>Far from potential viral epidemics</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>Very far from any nuclear facility</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
      ...
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>No Artificial Intelligence</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>No smart meters</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>No chlorine or fluoride in the water</span>
      </li>
      <li>
        <img loading="lazy" src="./assets/image/check.svg" alt="check">
        <span>3 germplasm banks of 9 hectares each</span>
      </li>
    </ul>
  </section>
  ...
  <section class="notice">
    <article class="notice__container">
      ...
      <div class="notice__description">
        <h3>"Refugio Amazónico Madre de Dios Inn: Explore Nature, Protect the Planet, Live Sustainable Tourism"</h3>
        <p>To generate economic sustainability, Refugio Amazónico Madre de Dios Inn will have a tour operator that will allow for income generation from tourism in the various tourist attractions of Madre de Dios, such as Monkey Island, sloth sanctuary, sport fishing, among others. Our residents will be able to rent out their country houses when they wish and generate rental income. This will allow for maintenance and economic sustainability.</p>
      </div>
    </article>
  </section>
  ...
  <div class="container__contact">
    <section id="contact" class="contact">
      <img loading="lazy" class="contact__mariposa" src="./assets/image/mariposa.webp" alt="butterfly">
      <form class="contact__form" id="contact-form" method="POST">
        ...
        <div class="contact__form--row">
          <div class="contact__form--group">
            ...
            <input type="text" id="name" name="name" placeholder="Write your first name correctly" required>
          </div>
          <div class="contact__form--group">
            <label for="last-name">Last Name</label>
            <input type="text" id="last-name" name="last_name" placeholder="Write your last name correctly" required>
          </div>
        </div>
        <div class="contact__form--row">
          <div class="contact__form--group">
            <label for="phonenumber">Phone Number</label>
            <input type="text" id="phonenumber" name="phonenumber" placeholder="Write your phone number correctly" required>
          </div>
          <div class="contact__form--group">
            <label for="email">Email</label>
            <input type="email" id="email" name="email" placeholder="Write your email correctly" required>
          </div>
        </div>
        <div id="response-message" style="display:none;"></div>
        <button class="contact__form--btn" id="submit-btn">Send Message</button>
      </form>
    </section>
  </div>
